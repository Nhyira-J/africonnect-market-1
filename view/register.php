...
<head>
  ...
  <title>Register | AfriConnect</title>
  ...
  <div class="auth-container">
    ...
    <div class="auth-image-side" style="background-image: url('../images/img_a_beautifully_crafted.png');">
      <div class="auth-content-overlay">
        <div class="auth-quote">"Discover the beauty of authentic African craftsmanship."</div>
    ...
    <div class="auth-form-side">
      ...
      <form action="../actions/register_process.php" method="POST">
        <?php if(isset($_GET['role']) && $_GET['role'] == 'artisan'): ?>
            <input type="hidden" name="role" value="artisan">
            <script>
                document.querySelector('.auth-title').textContent = 'Register as Artisan';
            </script>
        <?php endif; ?>
